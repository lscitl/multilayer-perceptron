...
if __name__ == "__main__":
    try:
        ...
        mlp.compile(
            optimizer=optimizer, loss="binaryCrossentropy", metrics=["accuracy"]
        )
        ...
        if "val_loss" in fit_history.history.keys():
            y_val_loss = fit_history.history["val_loss"]
        ...
        if "accuracy" in fit_history.history.keys():
            y_acc = fit_history.history["accuracy"]
            plt.plot(x_len, y_acc, c="black", label="Train-set Acc")

        if "val_accuracy" in fit_history.history.keys():
            y_val_acc = fit_history.history["val_accuracy"]
