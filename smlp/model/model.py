...
from smlp.layer.layers import LAYER, Layers
from smlp.callback.callback import Callback
from smlp.callback.history import History
...
class Model:
    ...
    def _init_params(self) -> None:
        ...
        for i, (l, l_next) in enumerate(zip(self.layer, self.layer[1:]), start=1):
            self.params['W' + str(i)] = l_next.weights_initializer.initialize((l.layer_dim, l_next.layer_dim))
